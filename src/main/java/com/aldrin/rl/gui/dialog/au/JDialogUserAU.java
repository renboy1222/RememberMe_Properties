...
import com.aldrin.rl.RememberLogin;
...
public class JDialogUserAU extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 270, 168, 40));
        ...
        setSize(new java.awt.Dimension(589, 372));
        ...
        try {
            ...
            if (returnVal == javax.swing.JFileChooser.APPROVE_OPTION) {
                ...
                try {
                    ...
                    ImageIO.write(resizedImage, "png", new File(RememberLogin.class.getProtectionDomain().getCodeSource().getLocation().getPath() + "\\images\\model.jpg"));
    ...
    private void validatePhoto() throws URISyntaxException {
        if (userAccount.getPhoto() == null) {
            File targetClassesDir = new File(RememberLogin.class.getProtectionDomain().getCodeSource().getLocation().getPath() + "\\images\\no photo.jpg");
            try {
